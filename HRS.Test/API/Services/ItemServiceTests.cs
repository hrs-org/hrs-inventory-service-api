...
//     {
//         // Arrange
//         _ = _itemRepository.GetByIdAsync("1")!.Returns((Item)null!);
//
//         // Act & Assert
...
//         {
//             new() { Id = "1", Name = "Item1", Description = "Desc1", CreatedById = user.Id },
//             new() { Id = "2", Name = "Item2", Description = "Desc2", CreatedById = user.Id }
//         };
//         var dtos = new List<ItemResponseDto> { new() { Id = "1" }, new() { Id = "2" } };
//         _itemRepository.GetRootItemsAsync(Arg.Any<string>()).Returns(items);
//         _mapper.Map<IEnumerable<ItemResponseDto>>(items).Returns(dtos);
//
//         // Act
//         var result = await _service.GetRootItemsAsync("1");
//
//         // Assert
...
//             StoreId = "1"
//         };
//         var entityUser = new UserResponseDto
//         {
//             Id = 1,
//             FirstName = "John",
//             LastName = "Doe",
...
//             {
//                 new() { Name = "Size 8", Description = "This is Size 8", Quantity = 2, CreatedById = entityUser.Id },
//                 new() { Name = "Size 10", Description = "This is Size 10", Quantity = 3, CreatedById = entityUser.Id }
//             }
//         };
...
//         _itemRepository.GetByIdAsync(Arg.Any<string>()).Returns(entity);
